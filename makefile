...
FILES = util.o pre_asm.o assembler.o  command_line.o linked_list.o asm_1.o encode.o asm_2.o  label_list.o

assembler: $(FILES)
	gcc -ansi -pedantic -Wall $(FILES) -o assembler

linked_list.o: linked_list.c linked_list.h
	gcc -c -ansi -pedantic -Wall linked_list.c -o linked_list.o

pre_asm.o: pre_asm.c $(HEADERS)
	gcc -c -ansi -pedantic -Wall pre_asm.c -o pre_asm.o
...
asm_2.o: asm_2.c $(HEADERS)
	gcc -c -ansi -pedantic -Wall asm_2.c -o asm_2.o
